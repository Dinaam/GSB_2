...
public class TestDaoPraticien {
    ...
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
        ...
        try {
            ...
            System.out.println("Test1 : selectOne");
            test2_selectOneByName("Notini");
            System.out.println("Test : effectué");
            System.out.println("Test1 : selectOne");
            test3_selectOneByNum(2);
            System.out.println("Test : effectué");
    ...
    public static void test2_selectOneByName(String name) throws SQLException, ClassNotFoundException {

        Praticien unPra = DaoPraticien.selectOneByName(name);
        System.out.println("Le type praticien qui a pour nom : " + name + " est : \n" + unPra.toString2());
    }
    public static void test3_selectOneByNum(int num) throws SQLException, ClassNotFoundException {

        Praticien unPra = DaoPraticien.selectOneByNum(num);
        System.out.println("Le type praticien qui a pour typCode : " + num + " est : \n" + unPra.toString2());
    }
