...
public class TestDaoSecteur {
    ...
    public static void test1_getNomSecteur(String code) throws SQLException, ClassNotFoundException {

        Secteur unSecteur = DaoSecteur.getNomSecteur(code);
        System.out.println("Le secteur qui a pour code : " + code + " est : \n" + unSecteur);
