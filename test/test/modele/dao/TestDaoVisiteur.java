...
public class TestDaoVisiteur {
    ...
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
        ...
        try {
            ...
            System.out.println("Test2 : selectOne");
            test2_SelectOne("a131");
    ...
    public static void test2_SelectOne(String matricule) throws SQLException, ClassNotFoundException {
        
        
        Visiteur unVisiteur = DaoVisiteurs.selectOneByMat(matricule);
        System.out.println("Le visiteur " + unVisiteur.toString2());
    }
    public static void test1_getAll() throws SQLException, ClassNotFoundException {
        
        
        List<Visiteur> lesVisiteurs = DaoVisiteurs.getAll();
