...
public class TestDaoFamille {
    ...
    public static void test1_getOneByCodeFam(String code) throws SQLException, ClassNotFoundException {

        Famille uneFamille = DaoFamille.getOneByCodeFam(code);
        System.out.println("La famille de médicament qui a pour code : " + code + " est : \n" + uneFamille);
