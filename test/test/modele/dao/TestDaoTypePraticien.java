...
public class TestDaoTypePraticien {
    ...
    public static void test1_getOneByCode(String code) throws SQLException, ClassNotFoundException {

        TypePraticien unType = DaoTypePraticien.getOneByCode(code);
        System.out.println("Le type de praticien qui a pour code : " + code + " est : \n" + unType.toString2());
